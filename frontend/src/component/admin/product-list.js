            ...
            <div className="overflow-x-auto">
                <table className="w-full table-fixed text-left">
                    <thead className="bg-[#F5F2EB] dark:bg-stone-800/50 border-b border-stone-200 dark:border-stone-700">
                        <tr>
                            <th className="px-6 py-4 text-xs font-bold text-stone-500 uppercase tracking-wider w-[20%]">
                                Tên sản phẩm
                            </th>
                                ...
                                >
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-3">
                                            <span className="font-semibold text-stone-700 dark:text-stone-200 whitespace-normal break-words" title={product.product_name}>
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`text-sm font-medium ${product.quantity > 0 ? 'text-stone-600 dark:text-stone-400' : 'text-red-500'}`}>
                                            {product.quantity}
                                        </span>
                                    </td>
